...
Finally, controls are offered for switching between the various sonification schemes. We provide the appropriate controls to enable, disable features of the model, and when appropriate, control parameters of their control.  
