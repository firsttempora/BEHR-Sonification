...
Now turn \textbf{OFF} all the rural sites and turn \textbf{ON} the following cities:
	...
	\item San Antonio, TX
	\end{itemize}
Also turn \textbf{ON} the season filter and increase the speed to \textbf{0.5}.
}
...
\instructions{Turn the seasonal filter \textbf{OFF}. Reset the speed to \textbf{0.05}.}	
...
\question Regional trends:
	...
	\part Which region had the greatest \ce{NO2} in 2005?\\
		...
		\choice Northwest
		\choice Southwest
		\choice These regions' trends sounded too similar
...
\instructions{For these next questions, start with only the rural sites \textbf{ON}. Turn on and off the sites and adjust the speed as needed to explore the data and answer the questions.}
...
\instructions{Now, turn \textbf{OFF} all sites \emph{except} Phoenix, AZ. Change panning to \textbf{\ce{NO2}/\ce{O3}}. Change scaling to \textbf{RELATIVE}. Turn \ce{O3} \textbf{ON}. Adjust the speed as needed to answer the question.}
