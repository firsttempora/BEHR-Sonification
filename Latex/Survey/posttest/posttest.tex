...
\instructions{\textbf{PAUSE} the playback. Turn \textbf{ON} all sites. Change synth sound to \textbf{UNIFORM}. Jump back to the beginning of the record and just stay on 2005-01-01.}
...
\instructions{Now, turn \textbf{OFF} all sites \emph{except} Phoenix, AZ. Change panning to \textbf{\ce{NO2}:left, \ce{O3}:right}. Change scaling to \textbf{RELATIVE TO INDIVIDUAL MAXIMUM}. Turn \ce{O3} \textbf{ON}. Adjust the speed as needed to answer the question.}
