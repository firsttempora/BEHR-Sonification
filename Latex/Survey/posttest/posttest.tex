...
\instructions{Turn the seasonal filter \textbf{OFF}.}	
...
\instructions{Turn \textbf{ON} all sites.}
...
\instructions{For these next questions, start with only the rural sites \textbf{ON}. Turn on and off the sites as needed to explore the data and answer the questions.}
